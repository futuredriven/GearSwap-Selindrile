function user_job_setup()
	...
	state.Weapons:options('Ragnarok','Apocalypse')
...
-- Relic Armor 
------------------------------------------------------------------
	gear.relic_head = {name="Fall. Burgeonet +1"}
	gear.relic_body = {name="Fall. Cuirass +1"}	
	gear.relic_hands = {name="Fall. Fin. Gaunt. +1"}
	gear.relic_legs = {name="Fall. Flanchard +1"}
	gear.relic_feet = {name="Fall. Sollerets +1"}
------------------------------------------------------------------
-- empyrean Armor
------------------------------------------------------------------
...
-- JSE Capes
------------------------------------------------------------------
	gear.tp_jse_back = {name="Ankou's Mantle", augments={'DEX+20','Accuracy+20 Attack+20','Accuracy+10','"Dbl.Atk."+10','Damage taken-5%',}}
	gear.fc_jse_back = {name="Ankou's Mantle", augments={'INT+20','Mag. Acc+20 /Mag. Dmg.+20','Mag. Acc.+10','"Fast Cast"+10','Damage taken-5%',}}
	gear.str_ws_jse_back = {name="Ankou's Mantle", augments={'STR+20','Accuracy+20 Attack+20','STR+10','Weapon skill damage +10%','Damage taken-5%',}}
	gear.int_ws_jse_back = {name="Ankou's Mantle", augments={'INT+20','Accuracy+20 Attack+20','INT+10','"Dbl.Atk."+10','Damage taken-5%',}}	
...
function init_gear_sets()
	...
	sets.precast.FC = {ammo="Impatiens",
		head="Carmine Mask +1",neck="Voltsurge Torque",ear1="Loquac. Earring",
		body="Odyss. Chestplate",hands="Leyline Gloves",ring1="Lebeche Ring",ring2="Kishar Ring",
		back=gear.fc_jse_back,waist="Flume Belt",legs=gear.odyssean_fc_legs,feet=gear.odyssean_fc_feet}
	...
	sets.midcast.FastRecast = {ammo="Staunch Tathlum",
		head="Carmine Mask +1",neck="Voltsurge Torque",ear1="Loquac. Earring",
		body="Odyss. Chestplate",hands="Leyline Gloves",ring1="Lebeche Ring",ring2="Kishar Ring",
		back=gear.fc_jse_back,waist="Tempus Fugit",legs=gear.odyssean_fc_legs,feet=gear.odyssean_fc_feet}
				   
	-- Specific spells
 
	sets.midcast['Dark Magic'] = {ammo="Pemphredo Tathlum",
		head="Carmine Mask +1",neck="Erra Pendant",ear1="Digni. Earring",
		body="Flamma Korazin +2",hands="Flam. Manopolas +2",ring1="Stikini Ring",ring2="Stikini Ring",
		back=gear.fc_jse_back,waist="Eschan Stone",legs="Eschite Cuisses",feet="Flam. Gambieras +2"}
		   
	sets.midcast['Enfeebling Magic'] = {ammo="Pemphredo Tathlum",
		head="Carmine Mask +1",neck="Erra Pendant",ear1="Digni. Earring",
		body="Flamma Korazin +2",hands="Flam. Manopolas +2",ring1="Stikini Ring",ring2="Stikini Ring",
		back=gear.fc_jse_back,waist="Eschan Stone",legs="Ratri cuisses",feet="Flam. Gambieras +2"}
		   
	sets.midcast['Dread Spikes'] = set_combine(sets.midcast['Dark Magic'], {})
	sets.midcast.Absorb = set_combine(sets.midcast['Dark Magic'], {back=gear.fc_jse_back})
	...
	sets.DrainWeapon = {main="Dacnomania"}
	...
	sets.precast.WS = {ammo="Knobkierrie",
		head="Ratri Sallet",neck="Abyssal Beads +2",ear1="Ishvara Earring",ear2="Moonshade Earring",
		body=gear.artifact_body,hands="Ratri Gadlings",ring1="Karieyh Ring",ring2="Niqmaddu Ring",
		back=gear.str_ws_jse_back,waist="Fotia Belt",legs="Ratri Cuisses",feet="Sulev. Leggings +2"}
	...
	sets.idle = {ammo="Staunch Tathlum",
		...
		body="Makora Meikogai",hands="Sulev. Gauntlets +2",ring1="Defending Ring",ring2="Niqmaddu Ring",
		back="Shadow Mantle",waist="Flume Belt",legs="Sulev. Cuisses +2",feet="Sulev. Leggings +2"}
		
	sets.idle.PDT = {ammo="Staunch Tathlum",
		head="Jumalik Helm",neck="Loricate Torque +1",ear1="Genmei Earring",ear2="Sherida Earring",
		body="Chozoron Coselete",hands="Sulev. Gauntlets +2",ring1="Defending Ring",ring2="Niqmaddu Ring",
		back="Shadow Mantle",waist="Flume Belt",legs="Sulev. Cuisses +2",feet="Sulev. Leggings +2"}
	...
	sets.engaged = {ammo="Ginsen",
		...
		body="Flamma Korazin +2",hands="Sulev. Gauntlets +2",ring1="Petrov Ring",ring2="Niqmaddu Ring",
		back=gear.tp_jse_back,waist="Ioskeha Belt +1",legs=gear.odyssean_stp_legs,feet="Flam. Gambieras +2"}
	sets.engaged.SomeAcc = {ammo="Aurgelmir Orb +1",
		head="Flam. Zucchetto +2",neck="Abyssal Beads +2",ear1="Brutal Earring",ear2="Cessance Earring",
		body="Flamma Korazin +2",hands="Sulev. Gauntlets +2",ring1="Flamma Ring",ring2="Niqmaddu Ring",
		back=gear.tp_jse_back,waist="Ioskeha Belt +1",legs=gear.odyssean_stp_legs,feet="Flam. Gambieras +2"}
	sets.engaged.Acc = {ammo="Aurgelmir Orb +1",
		head="Flam. Zucchetto +2",neck="Abyssal Beads +2",ear1="Digni. Earring",ear2="Telos Earring",
		body="Flamma Korazin +2",hands="Sulev. Gauntlets +2",ring1="Flamma Ring",ring2="Niqmaddu Ring",
		back=gear.tp_jse_back,waist="Ioskeha Belt +1",legs=gear.odyssean_stp_legs,feet="Flam. Gambieras +2"}
	sets.engaged.FullAcc = {ammo="Aurgelmir Orb +1",
		head="Flam. Zucchetto +2",neck="Abyssal Beads +2",ear1="Mache Earring +1",ear2="Telos Earring",
	...
	sets.engaged.Fodder = {ammo="Aurgelmir Orb +1",
		head="Flam. Zucchetto +2",neck="Abyssal Beads +2",ear1="Brutal Earring",ear2="Sherida Earring",
		body="Flamma Korazin +2",hands="Sulev. Gauntlets +2",ring1="Petrov Ring",ring2="Niqmaddu Ring",
		back=gear.tp_jse_back,waist="Ioskeha Belt +1",legs=gear.odyssean_stp_legs,feet="Flam. Gambieras +2"}
--Example sets:
--[[
...
-- Liberator melee sets
	...
	sets.buff['Dark Seal'] = {head=gear.relic_head}
	sets.buff.Souleater = {}
